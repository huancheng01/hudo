...
description: 新电脑或重装系统后，开发者往往要花半天时间逐个下载安装 Git、Node.js、JDK、Maven、MySQL、VS Code 等工具并配置环境变量。本文介绍如何使用 hudo 一键配置 Windows 开发环境，20 分钟搞定全部 27 款开发工具的安装、环境变量设置和国内镜像加速。
keywords:
  - Windows 开发环境
  - 一键配置
  - 新电脑
...
目前 hudo 支持 27 款常用开发工具，覆盖了绝大多数开发场景：

| 分类 | 工具 |
|------|------|
| 版本控制 | Git、GitHub CLI |
| JavaScript | Node.js、fnm、Bun |
| Python | uv、Miniconda |
| JVM | JDK、Maven、Gradle |
| 系统语言 | Go、Rust、.NET SDK、MinGW (C/C++) |
| 数据库 | MySQL、PostgreSQL、Redis |
| IDE/编辑器 | VS Code、PyCharm、IntelliJ IDEA |
| 终端与效率 | PowerShell 7、Oh My Posh（含 Nerd Font）、PowerToys、7-Zip |
